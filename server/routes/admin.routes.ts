...
// Routes extracted to separate files (SEED-004 fat-file refactor):
//   GET /api/admin/generations              → admin-generations.routes.ts
//   GET|PATCH /api/admin/image-provider     → admin-settings.routes.ts
//   GET|PATCH /api/admin/api-keys           → admin-settings.routes.ts
//   POST /api/admin/migrate-colors          → admin-settings.routes.ts
