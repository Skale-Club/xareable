...
export async function renderIndexHtml(template: string, req: Request) {
  ...
  // Inline SVG data URI fallback — avoids /favicon.png 404 when admin has not
  // uploaded a favicon. The browser also automatically probes /favicon.ico;
  // we serve a matching SVG there in client/public/.
  const DEFAULT_FAVICON_DATA_URI =
    "data:image/svg+xml,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2064%2064'%3E%3Crect%20width%3D'64'%20height%3D'64'%20rx%3D'12'%20fill%3D'%238b5cf6'%2F%3E%3Ctext%20x%3D'50%25'%20y%3D'56%25'%20text-anchor%3D'middle'%20font-family%3D'Inter%2Csans-serif'%20font-size%3D'40'%20font-weight%3D'700'%20fill%3D'white'%3EX%3C%2Ftext%3E%3C%2Fsvg%3E";
  const faviconUrl =
