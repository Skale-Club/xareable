    ...
    return (
        <Card className="shadow-none border-border">
            <CardHeader className="pb-4">
                ...
                <CardDescription>Select which AI models handle specific tasks across the platform.</CardDescription>
            </CardHeader>
            <CardContent className="grid gap-6 sm:grid-cols-3">
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Used for generating post images and editing images.</p>
                </div>

                <div className="space-y-2">
                    <Label className="text-sm font-medium">Text Generation & Prompts</Label>
                    <Select 
                    ...
                    <p className="text-xs text-muted-foreground">Used for expanding user prompts, writing captions, and generating ideas.</p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Used for transcribing voice notes into text inputs.</p>
                </div>
            </CardContent>
        </Card>
    );
