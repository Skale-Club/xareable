...
- [ ] 26-05-PLAN.md — Wave 2: POL-08 — cost-reconciliation runbook + usage_events query scaffold (scheduled, deliberately not run, not cron-wired)
...
| 26. Fixes & Polish | v1.6 | 2/10 | In Progress|  |
