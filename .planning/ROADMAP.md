...
Plans:
- [ ] 21-01-PLAN.md — Wave 1: verify-phase-21 harness skeleton + GATE-08 video baseline hash freeze
...
- [ ] 21-07-PLAN.md — Wave 5: gemini.service.ts generateText/generateCaptionOnly via gateway; direct rollback branch; dead transcribeAudio deleted
- [ ] 21-08-PLAN.md — Wave 5: carousel master plan + caption-quality + enhancement pre-screen/caption via gateway; cost totals surfaced
- [ ] 21-09-PLAN.md — Wave 5: transcribe route via gateway + billing wiring + header fix
- [ ] 21-10-PLAN.md — Wave 6: generate + edit routes real-cost billing (GATE-05)
- [ ] 21-11-PLAN.md — Wave 6: carousel + slide-edit real-cost billing (GATE-05)
- [ ] 21-12-PLAN.md — Wave 6: enhancement real-cost billing (GATE-05)
...
| 21. OpenRouter Gateway Foundation | v1.6 | 0/13 | Planned | - |
